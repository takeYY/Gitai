...
def show():
    ...
    if errors:
        for error in errors:
            flash(error, 'error')
        return render_template('preprocessing.html', basic_data=basic_data, sent_data=sent_data_dict, other_option=other_option, description=other_option_description)
    # 送るデータをまとめる
