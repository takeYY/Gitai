...
def render_index(basic_data: dict, other_option: dict, description: dict,
                 input_data: dict = None, option: dict = None):
...
def render_result(basic_data: dict, other_option: dict, description: dict,
                  input_data: dict = None, option: dict = None, result: dict = None):
    return render_template('text_preprocessing/index.html',
                           basic_data=basic_data,
                           other_option=other_option,
                           description=description,
...
def show():
    ...
    preprocessed_text, errors = texts_preprocessing(texts,
                                                    ...
                                                    other_options)
    # 送るデータの辞書
    option = dict(remove_texts=remove_words, replace_texts=replace_words,
    ...
    return render_result(basic_data, other_option, description,
                         input_data, option, result)
