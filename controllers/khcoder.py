...
khcoder_page = Blueprint("khcoder", __name__, url_prefix="/khcoder")
...
def show():
    ...
    # csvダウンロード設定
    dl_data = dict(file_name=file_name, dl_type="khcoder", new_name=file_name)
    # 送信するデータの作成
    sent_data = dict(name=name, file_name=file_name, df=get_khcoder_df(file_name))
